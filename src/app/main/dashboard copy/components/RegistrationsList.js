...
function RegistrationsList(props) {
  ...
  const customerBranch = useSelector(
    ({ customersApp }) => customersApp
  );
console.log(customerBranch, 'branch');


  const dashboardcopy = useSelector(
    ({ dashboardApp }) => dashboardApp
  );

  console.log(dashboardcopy, " dashboardcopy");
  ...
  return (
    <div className='flex flex-col mt-16'>
      <div className='shadow overflow-hidden border-b border-gray-200 sm:rounded-lg'>
        <h2 className='px-20 py-8'>Select Branch</h2>
